...
COLOR_PROMPTS = {
    ...
    "yellow":   "a photo of bright, vivid yellow clothing, like a sunflower or lemon, pure and saturated",
    ...
    "beige": "a photo of pale neutral beige clothing, very light, between white and tan, almost no color saturation",
    ...
    "orange":   "a photo of vivid orange clothing, a warm reddish-yellow like an orange fruit",
    "coral": "a fashion photograph of clothing in a warm coral tone, a soft pinkish-orange hue prominently visible across the fabric, studio lighting against a neutral background",
